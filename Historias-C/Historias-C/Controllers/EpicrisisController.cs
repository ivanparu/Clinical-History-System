...
namespace Historias_C.Controllers
{
    public class EpicrisisController : Controller
    {
        ...
        {
            var historiasClinicasCContext = _context.Epicrisis.Include(e => e.Diagnostico).Include(e => e.Episodio).Include(e => e.Medico);
        ...
        public async Task<IActionResult> Create([Bind("Id,EpisodioId,MedicoId,fechaYHora,DiagnosticoId")] Epicrisis epicrisis)
        {
            ...
            ViewData["DiagnosticoId"] = new SelectList(_context.Diagnosticos, "Id", "Descripcion", epicrisis.DiagnosticoId);

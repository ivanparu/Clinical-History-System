...
namespace Historias_C.Controllers
{
    public class EpisodiosController : Controller
    {
        ...
        {
            var historiasClinicasCContext = _context.Episodios.Include(e => e.Epicrisis).Include(e => e.HistoriaClinica);
        ...
        public async Task<IActionResult> Create([Bind("Id,Motivo,Descripcion,FechaYHoraInicio,FechaYHoraCierre,FechaYHoraAlta,EstadoAbierto,EpicrisisId,HistoriaClinicaId")] Episodio episodio)
        {
            ...
            ViewData["EpicrisisId"] = new SelectList(_context.Epicrisis, "Id", "Id", episodio.EpicrisisId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Motivo,Descripcion,FechaYHoraInicio,FechaYHoraCierre,FechaYHoraAlta,EstadoAbierto,EpicrisisId,HistoriaClinicaId")] Episodio episodio)
        {
            if (id != episodio.Id)
            {
                return NotFound();

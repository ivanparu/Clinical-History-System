...
namespace Historias_C.Controllers
{
    public class NotasController : Controller
    {
        ...
        {
            var historiasClinicasCContext = _context.Notas.Include(n => n.Evolucion);
        ...
        public async Task<IActionResult> Create([Bind("Id,EvolucionId,Mensaje,FechaYHora")] Notas notas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EvolucionId,Mensaje,FechaYHora")] Notas notas)
        {
            if (id != notas.Id)
            {
                return NotFound();

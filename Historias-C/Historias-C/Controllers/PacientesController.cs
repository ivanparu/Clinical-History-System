...
namespace Historias_C.Controllers
{
    public class PacientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ObraSocial,HistoriaClinicaId,Id,UserName,Password,Email,FechaAlta,Nombre,Apellido,DNI,Telefono")] Paciente paciente)
        {
            if (id != paciente.Id)
            {
                return NotFound();
